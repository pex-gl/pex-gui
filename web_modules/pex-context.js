  ...
  Object.assign(ctx, {
    ...
    submit: function (cmd, batches, subCommand) {
      ...
      if (this.debugMode) {
        ...
        log$2('fbo-state', '  '.repeat(this.stack.length), cmd.name, framebufferCanged ? `${prevFramebufferId} -> ${currFramebufferId}` : currFramebufferId, [...this.state.viewport], this.state.scissor ? [...this.state.scissor] : "[]");
      }
