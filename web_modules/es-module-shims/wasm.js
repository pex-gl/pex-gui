...
/* ES Module Shims Wasm 1.10.1 */ (function() {
    ...
    /* es-module-lexer 1.5.4 */ var ImportType;
    !function(A) {
    ...
    function parse(E, g) {
        ...
        for(; C.ri();){
            ...
            let o;
            C.ip() && (o = k(E.slice(-1 === I ? A - 1 : A, -1 === I ? Q + 1 : Q))), D.push({
                n: o,
                t: B,
                s: A,
                e: Q,
        ...
        for(; C.re();){
            const A = C.es(), Q = C.ee(), B = C.els(), g = C.ele(), I = E.slice(A, Q), w = I[0], K = B < 0 ? void 0 : E.slice(B, g), D = K ? K[0] : "";
            o.push({
                s: A,
                e: Q,
                ls: B,
