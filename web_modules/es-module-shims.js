...
import { c as commonjsGlobal } from './common/web.dom-collections.iterator-24f03f52.js';
...
import './common/es.typed-array.uint16-array-96e18efe.js';
...
(function () {
  ...
  const featureDetectionPromise = Promise.resolve(dynamicImportCheck).then(() => {
    ...
    return new Promise(resolve => {
      ...
      document.head.appendChild(iframe); // setting srcdoc is not supported in React native webviews on iOS
